...
|---|---|
| [F1 Safety Car / VSC Light Flasher](./Home%20Assistant%20Blueprints/f1_safety_car_light_flasher.yaml) | Flashes a light when an F1 session goes live or the track goes to Virtual Safety Car, at different speeds so you can tell them apart |
